        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dirs_FileTypes_FileTypeId",
            ...
            migrationBuilder.InsertData(
                table: "Dirs",
                columns: new[] { "Id", "AddTime", "FileName", "FileTypeId", "IsVisible", "MapPath", "ParentId", "Size", "Sys", "TypeId" },
                values: new object[] { new Guid("353b4b8b-d59c-4d64-8e5c-9faedfc20cc0"), new DateTime(2021, 1, 29, 22, 19, 23, 953, DateTimeKind.Local).AddTicks(7666), "root", null, true, "", null, null, null, null });

            migrationBuilder.CreateIndex(
                name: "IX_Dirs_FileTypeId",
                table: "Dirs",
                column: "FileTypeId");
